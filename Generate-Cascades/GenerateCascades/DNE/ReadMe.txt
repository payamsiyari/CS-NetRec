...
In addition, generate-nets and netinf-noise are also provided. They allow to
build Kronecker and Forest-Fire networks, generate cascades, and analyze the
effect of noise in NETINF. Please, run without any argument to see how to
use them.
